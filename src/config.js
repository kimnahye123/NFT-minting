export const CONTRACTADDRESS = "0xcEA8e2dBC3F6fA4c0B2D29f9352Cf286dED7A0C1";
export const ABI = [
  {
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { internalType: "uint256", name: "requestedCount", type: "uint256" },
    ],
    name: "airDropMint",
    outputs: [],
    payable: false,
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: "uint256", name: "newAntibotInterval", type: "uint256" },
      {
        internalType: "uint256",
        name: "newMintLimitPerBlock",
        type: "uint256",
      },
      { internalType: "uint256", name: "newMintLimitPerSale", type: "uint256" },
      {
        internalType: "uint256",
        name: "newMintStartBlockNumber",
        type: "uint256",
      },
      { internalType: "uint256", name: "newMintIndexForSale", type: "uint256" },
      { internalType: "uint256", name: "newMaxSaleAmount", type: "uint256" },
